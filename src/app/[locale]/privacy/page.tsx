    ...
    <div className="container" style={{ padding: '4rem 1rem', maxWidth: '800px', margin: '0 auto' }}>
      ...
      <div className="content-section" style={{ display: 'flex', flexDirection: 'column', gap: '2rem', textAlign: 'justify' }}>
        ...
        <section>
          ...
          <p>{t('s2Text')}</p>
          <ul style={{ listStyleType: 'disc', paddingLeft: '2rem', display: 'flex', flexDirection: 'column', gap: '0.5rem', marginTop: '1rem' }}>
            <li dangerouslySetInnerHTML={{ __html: t.raw('s2Li1') }} />
            <li dangerouslySetInnerHTML={{ __html: t.raw('s2Li2') }} />
            <li dangerouslySetInnerHTML={{ __html: t.raw('s2Li3') }} />
          </ul>
        </section>
